...
rs_nd_nb = run_scan(fixed_params, fixed_param_vals, floated_params, floated_param_priors, Ns = 200, Nang = 4, share_betas=True, use_prior=True)
rs_nd_nb.perform_scan_multinest(chains_dir='chains/rs_nd_nb/')